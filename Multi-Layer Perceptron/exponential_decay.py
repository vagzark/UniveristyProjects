...
class NeuralNetwork:
    def __init__(self, input_size, hidden_sizes, output_size, learning_rate=0.01):
        ...
        self.initial_learning_rate = learning_rate  # Αποθηκεύουμε το αρχικό learning rate
        self.weights = []
        self.biases = []
    ...
    # Εκπαίδευση με Exponential Decay
    def train(self, X_train, y_train, X_test, y_test, epochs=10, batch_size=128, decay_rate=0.01):
        best_epoch = None
        best_accuracy = 0
        best_stats = {}
        ...
        for epoch in range(epochs):
            # Μείωση Learning Rate με Exponential Decay
            self.learning_rate = self.initial_learning_rate * np.exp(-decay_rate * epoch)
            ...
            print(f"Current Learning Rate: {self.learning_rate:.5f}")
...
if __name__ == "__main__":
    ...
    nn.train(train_data, train_labels, test_data, test_labels, epochs=200, batch_size=128, decay_rate=0.01)
