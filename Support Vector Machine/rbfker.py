...
print("\nΠειραματισμός με διαφορετικές τιμές των C και gamma:")
for C in C_values:
    for gamma in gamma_values:
        print(f"\nΕκπαίδευση SVM με C={C}, gamma={gamma} (RBF Kernel)...")
        start_time = time.time()
        svm_rbf = SVC(kernel='rbf', C=C, gamma=gamma, decision_function_shape='ovo')
        ...
        y_pred_train = svm_rbf.predict(X_train_pca)
        y_pred_test = svm_rbf.predict(X_test_pca)
