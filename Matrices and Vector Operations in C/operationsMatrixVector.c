...
void create_array(double ***array,int array_num,struct coordinates array1[N])
{
    ...
    printf("\nEnter the dimensions of the matrix you wish to insert: ");
    printf("\nRows -> ");
    scanf("%d", &row);
    printf("Collumns -> ");
    scanf("%d", &coll);
...
void create_vector(double **vector,int vector_num,int vector_dim[N])
{
    ...
    printf("\nWhat is the dimension of the vector you want to insert?\n");
    printf("-> ");
    scanf("%d",&dim);
